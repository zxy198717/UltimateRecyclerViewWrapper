 ...
 */
public class SparseArrayViewHolder extends RecyclerViewHolder {
    ...
    public SparseArrayViewHolder listeningClick(int viewId) {
        return setOnClickListener(viewId, this);
    }
